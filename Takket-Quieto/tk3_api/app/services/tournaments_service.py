...
class TournamentsService:
    ...
    def create_tournament(
        self, db: Session, tournament: TournamentCreate
    ) -> Tournament:
        """
        ...
        """
        db_tournament = Tournament(name=tournament.name, status=TournamentStatus.DRAFT)
    ...
    def update_tournament(
        self, db: Session, tournament_id: int, tournament_update: TournamentUpdate
    ) -> Optional[Tournament]:
        """
    ...
    def add_participant(
        self, db: Session, tournament_id: int, participant: ParticipantCreate
    ) -> Optional[Player]:
        """
        ...
        db_participant = TournamentPlayer(
            tournament_id=tournament_id, player_id=participant.player_id
        )
    ...
    def generate_bracket(self, db: Session, tournament_id: int) -> List[Match]:
        ...
        if tournament.status != TournamentStatus.DRAFT:
            raise Exception(
                "Bracket can only be generated for tournaments in DRAFT status"
            )
